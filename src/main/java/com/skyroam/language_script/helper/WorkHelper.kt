...
import com.skyroam.language_script.Config
...
object WordHelper {
    ...
    /**
     * 解析当前的多语言内容 <语言目录（如values），<name，word>>
     */
    ...
    fun importWords(newLangNameMap: LinkedHashMap<String, LinkedHashMap<String, String>>, parentDir: File) {
        Log.e(TAG, "importWords, parentDir $parentDir")
